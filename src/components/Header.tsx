...
const Header = () => {
  return (
    <div className=" w-11/12 m-auto h-[70px] flex items-center flex-row justify-between ">
      <div className="w-2/6">
        {" "}
      ...
      <div className=" w-2/6 flex flex-row justify-end gap-6 pr-2">
        <div className="rounded-full w-[30px] bg-opacity-15 relative bg-yellow-100 mt-2">
          <span className="text-yellow-500  text-3xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
            LB
          </span>
        </div>
